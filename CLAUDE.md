...
The user may have a real pomodoro timer running. NEVER run `mb-todo` commands against the default data directory.
Always use `--data-dir /tmp/mb-todo-test` (or similar) for any manual verification.
